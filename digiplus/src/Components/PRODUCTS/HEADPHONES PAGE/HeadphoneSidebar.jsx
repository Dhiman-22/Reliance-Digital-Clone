...
function HeadphoneSidebar({isLoading}){
    return(
        <Stack>
            ...
            <Skeleton isLoaded={isLoading}>
                <Box  w="100%" bg="#fff" h="auto" mt={1} p={4} >
                    ...
                    <Checkbox defaultChecked mr="200px">
                        <Text textStyle="SideBarText">Headphones</Text></Checkbox>
             ...
             <Skeleton isLoaded={isLoading}>
                <Box  w="100%" bg="#fff" h="auto" mt={1} p={4} >
                    ...
                    <Checkbox mr="200px">
                        <Text textStyle="SideBarText">boAt</Text>
                    </Checkbox>
                    <Checkbox mr="200px">
                        <Text textStyle="SideBarText">JBL</Text>
                    </Checkbox>
                    <Checkbox mr="200px">
                        <Text textStyle="SideBarText">Zebronics</Text>
                    </Checkbox>
                    <Checkbox mr="200px">
                        <Text textStyle="SideBarText">Sony</Text>
                    </Checkbox>
                    <Checkbox mr="200px">
                        <Text textStyle="SideBarText">Philips</Text>
                    </Checkbox>
                    <Checkbox mr="200px">
                        <Text textStyle="SideBarText">pTron</Text>
                    </Checkbox>
                    <Checkbox mr="200px">
                        <Text textStyle="SideBarText">Skullcandy</Text>
                    </Checkbox>
                    <Checkbox mr="200px">
                        <Text textStyle="SideBarText">Firebolt</Text>
                    </Checkbox>
...
export default HeadphoneSidebar;